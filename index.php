...
<section class="welcome-sect py-4 clearfix"  >
	...
	<div class="container-fluid">
		...
		<div class="box box-style icon-fill-none"><a href="https://wa.me/message/GXBGXOJQZ3CIK1?text=I+have+an+issue.+Please+Help+Me+&amp;app_absent=0" class="icon-ttl-no text-lowercase">
					<div class="icon" style="border:0 !important;"><img src="images/icons8-whatsapp.gif" style="width:100%; "></div>
					</a><div class="icon-ttl"><a href="https://wa.me/message/GXBGXOJQZ3CIK1?text=I+have+an+issue.+Please+Help+Me+&amp;app_absent=0" class="icon-ttl-no text-lowercase">
		...
		<div class="row g-3 mb-4">
			...
			<div class="col-12">
				<a href="battle?type=Ludo%20Classic" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/ludoclassic.jpg" class="img-fluid">
					</div>
...
<!-- 
			<div class="col-6">
				<a href="battle?type=Ludo%20Popular" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/ludopopular.jpg" class="img-fluid">
					</div>
					<div class="game-title">
						<img src="images/battleIcon.png" class="battle-img">
						Ludo Popular
			...
			<!-- <div class="col-6">
				<a href="battle?type=First%20Six%20Win" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/firstsixwin.jpg" class="img-fluid">
					</div>
					<div class="game-title">
						<img src="images/battleIcon.png" class="battle-img">
						First Six Win
			...
			<div class="col-6">
				<a href="battle?type=1%20goti%20win" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/1gotiwin.jpg" class="img-fluid">
					</div>
					<div class="game-title">
						<img src="images/battleIcon.png" class="battle-img">
						1 Goti Win
			...
			<div class="col-6">
				<a href="battle?type=Quick%20Ludo" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/quickludo.jpg" class="img-fluid">
					</div>
					<div class="game-title">
						<img src="images/battleIcon.png" class="battle-img">
						Quick ludo
			...
			<div class="col-6">
				<a href="" class="game-block">
					<div class="game-status text-end text-uppercase primary-color"><span>•</span> Live </div>
					<div class="game-img">
						<img src="images/comingsoon.jpg" class="img-fluid">
					</div>
					<div class="game-title">
						<img src="images/battleIcon.png" class="battle-img">
						Coming soon
...
-->
		...
		<!--	<div class="col-6">
			...
			<a href="./superludo_v1.apk"><img src="images/play-store.png" height="40" class="rounded"></a>
		</div>
		</div>
...
<!-- Footer -->
	...
	<div class="right-bar" >
		...
		<div class="rcBanner-footer">
			...
			<a href="#!" class="primary-color text-decoration-underline"> SuperLudo.in</a> on <img src="images/global-chrome.png" alt="" height="20"> chrome mobile
		</div>
	</div>
</div><!-- // Main -->
