						...
						<div class="login-block">
							...
							<form name="myform" method="GET" id="submit_form">
								...
								<div class="form-group mb-3">
									<button type="button" class="btn btn-1 w-100" id='loginotp' name="loginotp">Login With OTP</button>
								 
								</div>
								<div class="row">
	<div class="col-6  mb-3 text-right">
		<a href="login" class="bold" id="request-otp" style="color:#ffeb5d;"> Login with Password </a>
